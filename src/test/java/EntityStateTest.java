...
public class EntityStateTest {
    ...
    void test2() {
        ...
        try {
            ...
            Memo memo = em.find(Memo.class, 8);
    ...
    void test3() {
        ...
        try {
            ...
            Memo memo1 = em.find(Memo.class, 5);
            Memo memo2 = em.find(Memo.class, 8);
    ...
    void test4() {
        ...
        try {
            ...
            em.close();
            Memo memo = em.find(Memo.class, 8); // Session/EntityManager is closed 메시지와 함께 오류 발생
            System.out.println("memo.getId() = " + memo.getId());
    ...
    void test6() {
        ...
        try {
            ...
            Memo memo = em.find(Memo.class, 9);
            System.out.println("memo.getId() = " + memo.getId());
            System.out.println("memo.getUsername() = " + memo.getUsername());
            System.out.println("memo.getContents() = " + memo.getContents());
